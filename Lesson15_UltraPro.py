...
#load my numbers
p1 = image.load_img(path=path+"h7l.JPEG", target_size=(28,28), color_mode="grayscale")
p5 = image.load_img(path=path+"h8l.JPEG", target_size=(28,28), color_mode="grayscale")
